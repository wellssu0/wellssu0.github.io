---
layout:     post
title:     HTML5之web存储、网络状态、应用缓存
subtitle:   
date:       2019-11-04
author:     wells
header-img: img/c20.jpg
catalog: true
tags:
...
<script>
    ...
    btns[0].onclick = function () {
        ...
        window.sessionStorage.setItem('pwd', '111111');
...
> 我们可以在浏览器调试工具的Application中的 Storage 选项卡中查看 Session Storage 和Local Storage。
...
<body>
<img src="http://img.hhh.com/111.jpg" alt=""/>
</body>
</html>
```
